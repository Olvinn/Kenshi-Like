...
namespace Data
{
    ...
    public class Constants : ScriptableSingleton<Constants>
    {
        ...
        [field: SerializeField, Tooltip("How fast unit rotates on target")] public float AgentsAngularSpeed { get; private set; } = 120;
        ...
        [field: SerializeField] public float CameraDistanceCulling { get; private set; } = 25f;
